...
![image-20230209171150658](img/仓库.png)
...
![](img-database/软件包位置.png)

**怎么确认安装完成了**
![](img-database/如何确认mysql安装完成.png)

需要配置环境变量



![](img-database/默认安装目录.png)
默认安装目录： `C:\Program Files\MySQL\MySQL Server 5.7`。里面有一个`bin`目录，都是启动命令等。

环境变量的设置
![](img-database/设置环境变量.png)
...
- 日期
	...
	- <font color=red><b>timestamp</b></font>: 年月日时分秒。(YYYY-MM-DD HH:MM:SS)。
...
是因为没有开这个选项。有的同学 `SELECT * from students group bu class;`不报错。 
...
![image-20220512104553268](img-database/image-20220512104553268.png)
...
![image-20230410161359471](img/image-20230410161359471.png)
