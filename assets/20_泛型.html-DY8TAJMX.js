import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as c,o as p,c as o,a as s,b as n,d as l,w as i,f as a}from"./app-1Qf3snIj.js";const d="/assets/image-20230128152912943-DEfxsnH4.png",u="/assets/参数化类型-Bg28znZE.png",r="/assets/image-20230129090114444-BM8C7oYu.png",v={},m=a(`<h1 id="基础概念" tabindex="-1"><a class="header-anchor" href="#基础概念" aria-hidden="true">#</a> 基础概念</h1><p><strong>学习目标：</strong></p><ul><li><p>理解泛型的概念及掌握泛型的好处</p></li><li><p>泛型类、泛型接口的定义</p></li><li><p>理解泛型在父子继承关系上的表现</p></li><li><p>理解泛型的擦除</p></li></ul><h2 id="引入" tabindex="-1"><a class="header-anchor" href="#引入" aria-hidden="true">#</a> 引入</h2><p><strong>背景条件</strong></p><ul><li>汽车类</li><li>汽车的车库(主要用于存放车)。还提供一个方法获取汽车。</li></ul><div class="language-JAVA line-numbers-mode" data-ext="JAVA"><pre class="language-JAVA"><code>/**
 * 类： 希望被持有的小汽车类
 * 功能： 里面只有一个run方法，打印。
 */
